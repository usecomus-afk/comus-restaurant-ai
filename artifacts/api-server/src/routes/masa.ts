...
<script>
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  #barActions{display:grid;grid-template-columns:1fr 1fr;gap:8px;width:100%}
  .bar-btn{
    border-radius:8px;border:none;color:#F4EEE6;
    font-family:var(--font-sans);font-size:13px;font-weight:600;
    height:44px;padding:6px 6px;display:flex;align-items:center;justify-content:center;gap:3px;
